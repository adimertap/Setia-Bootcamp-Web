                ...
                <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                    ...
                    <a class="nav-item nav-link active" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab"
                        ...
                        <div class="wizard-step-text">
                            <div class="wizard-step-text-name">Form Edit Pengumuman</div>
                    ...
                    <div class="tab-pane py-2 py-xl-2 fade show active" id="wizard1" role="tabpanel"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xxl-10 col-xl-10">
                                ...
                                <form action="{{ route('pengumuman.update', $item->id_pengumuman) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select name="qualification" id="qualification" class="form-control"
                                                ...
                                                <option value="{{ $item->qualification}}">{{ $item->qualification }}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="number" class="form-control" placeholder="Input Kisaran Gaji" id="harga_kelas"
                                                name="job_salary" value="{{ number_format($item->job_salary) }}"
                                            ...
                                            <div class="small">
                                                ...
                                                <span id="detailharga">{{ number_format($item->job_salary) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="job_description" type="text" rows="5" cols="5"
                                            ...
                                            class="form-control @error('job_description') is-invalid @enderror" required>{{ $item->job_description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="job_requirement" type="text" rows="5" cols="5"
                                            ...
                                            class="form-control @error('job_requirement') is-invalid @enderror" required>{{ $item->job_requirement }}</textarea>
