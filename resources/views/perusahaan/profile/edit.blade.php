                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-11">
                            <div class="card mt-5">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <div class="h3 text-primary font-weight-300 mb-0">Edit Profile Perusahaan</div>
                                </div>
                                <hr class="m-0">
                                <div class="card-body p-5">
                                    <form action="{{ route('profile-perusahaan.update', $profile->id_perusahaan) }}" method="POST" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <select name="jenis_perusahaan" id="jenis_perusahaan" class="form-control form-control-solid"
                                                    ...
                                                    <option value="{{ $profile->jenis_perusahaan }}">{{ $profile->jenis_perusahaan }}</option>
                                        ...
                                        <div class="row">
                                            <div class="col-4 form-group">
                                                ...
                                                <input class="form-control form-control-solid" id="tanggal_berdirinya"
                                                    ...
                                                    value="{{ $profile->tanggal_berdirinya }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-6">
                                                ...
                                                <input class="form-control form-control-solid" id="avatar" type="file" name="avatar"
                                                    value="{{ $profile->User->avatar }}" accept="image/*" multiple="multiple"
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input class="form-control form-control-solid" id="foto_perusahaan" type="file" name="foto_perusahaan"
                                                    value="{{ $profile->foto_perusahaan }}" accept="image/*" multiple="multiple"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-solid" id="alamat_kantor"
                                                ...
                                                value="{{ $profile->alamat_kantor }}"
                                                class="form-control @error('alamat_kantor') is-invalid @enderror"
                                                required>{{ $profile->alamat_kantor }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-solid" id="description"
                                                ...
                                                placeholder="Input Deskripsi Perusahaan" rows="5"
                                                value="{{ $profile->description }}"
                                                class="form-control @error('description') is-invalid @enderror">{{ $profile->description }}</textarea>
                                            @error('description')<div class="text-danger small mb-1">{{ $message }}
                                            </div> @enderror
                                        </div>
                                        <div class="form-group">
                                            <button class="btn btn-block btn-primary" type="submit">Edit Profile</button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
