    ...
    <div class="container-fluid">
        <div class="card mb-4">
            <div class="card card-header-actions">
                <div class="card-header">List Jenis Kelas
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                ...
                                                style="width: 80px;">Jenis Kelas</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 170px;">Keterangan</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <a href="" class="btn btn-primary btn-datatable" type="button"
                                                    data-toggle="modal"
                                                    data-target="#Modaledit-{{ $item->id_jenis_kelas }}">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="" class="btn btn-danger btn-datatable" type="button"
                                                    data-toggle="modal"
                                                    data-target="#Modalhapus-{{ $item->id_jenis_kelas }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Jenis Kelas</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">×</span></button>
            </div>
            <form action="{{ route('jenis-kelas.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="small mb-1 mr-1" for="jenis_kelas">Nama Jenis Kelas</label><span class="mr-4 mb-3" style="color: red">*</span>
...
@forelse ($jenis_kelas as $item)
<div class="modal fade" id="Modaledit-{{ $item->id_jenis_kelas }}" data-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
            ...
            <form action="{{ route('jenis-kelas.update', $item->id_jenis_kelas) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <label class="small mb-1">Isikan Form Dibawah Ini</label>
...
@forelse ($jenis_kelas as $item)
<div class="modal fade" id="Modalhapus-{{ $item->id_jenis_kelas }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('jenis-kelas.destroy', $item->id_jenis_kelas) }}" method="POST" class="d-inline">
                @csrf
                @method('delete')
                <div class="modal-body">Apakah Anda Yakin Menghapus Data Master Jenis Kelas {{ $item->jenis_kelas }} ?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Close</button>
