                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xxl-10 col-xl-10">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label class="small mb-1 mr-1" for="nama_project">Email User</label>
                                                    <input class="form-control" id="nama_project" type="text"
                                                        name="nama_project" placeholder="Input Nama Project"
                                                        value="{{ $item->User->emails }}" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1 mr-1" for="deskripsi_project">Kelas</label>
