            ...
            <div class="row justify-content-center empty-state">
                <div class="col-lg-12 col-10 text-center">
                    ...
                    <div class="d-grid flex-column justify-content-center gap-4">
                        ...
                        data-toggle="modal" style="border-radius: 30px;display: none" data-target="#Modalreview"
                        id="buttonmodal">
...
<div class="modal fade" id="Modalreview" tabindex="-1" role="dialog" data-backdrop="static"
    aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="exampleModalCenterTitle">Review Kelas</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="feedback">
                        <div class="rating" id="star-rating">
                            <input type="radio" name="bintang" id="rating-5" value="5">
                            <label for="rating-5"></label>
                            <input type="radio" name="bintang" id="rating-4" value="4">
                            <label for="rating-4"></label>
                            <input type="radio" name="bintang" id="rating-3" value="3">
                            <label for="rating-3"></label>
                            <input type="radio" name="bintang" id="rating-2" value="2">
                            <label for="rating-2"></label>
                            <input type="radio" name="bintang" id="rating-1" value="1">
                        ...
                        <div class="small">Pilih Rating Bintang 1-5</div>
                    </div>
                    <div class="form-group">
                        <label class="small mb-1 mr-1" for="review">Review</label>
                        <textarea class="form-control" id="review" type="text"
                            name="review" placeholder="Input Review Kelas" value="{{ old('review') }}"
                            class="form-control @error('review') is-invalid @enderror" required></textarea>
                        @error('review')<div class="text-danger small mb-1">{{ $message }}
                        </div> @enderror
                    </div>
                </div>
