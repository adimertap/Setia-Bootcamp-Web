        ...
        <div class="row">
            <div class="col-6">
                <div class="card" style="border-radius: 20px">
                    <section>
                        <form action="{{ route('portofolio-saya.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-xxl-10 col-xl-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="url_project" type="text" name="url_project"
                                                placeholder="Input URL Project" value="{{ old('url_project') }}"
